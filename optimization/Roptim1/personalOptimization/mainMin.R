...
main_grid_min <- function(vetorProcura,vetorSeraFds,lower,upper,numero_iteracoes){
#FUNCAO DE AVALIACAO
eval <- function(vetor){
...
iter=nsearches^D;
result=gsearch(fn=eval,lower=lower,upper=upper,step=step,type="min")
return(result);
}

# FUNCAO MAIN, RESPONSAVEL PELO RUN GLOBAL
main_hill_min <- function(vetorProcura,vetorSeraFds,lower,upper,numero_iteracoes){
#FUNCAO DE AVALIACAO
eval <- function(vetor){
#INIT VARIAVEIS PRINCIPAIS
custo_total <- 0;
...
result=hclimbing(par=s0,fn=eval,change=rchange1,lower=lower,upper=upper,type="min",
             control=list(maxit=N,REPORT=REPORT,digits=1))
return(result);
}

# FUNCAO MAIN, RESPONSAVEL PELO RUN GLOBAL
main_mc_min <- function(vetorProcura,vetorSeraFds,lower,upper,numero_iteracoes){
#FUNCAO DE AVALIACAO
eval <- function(vetor){
#INIT VARIAVEIS PRINCIPAIS
custo_total <- 0;
...
result <- mcsearch(eval,lower,upper,numero_iteracoes,type="min");
return(result);
}

# FUNCAO MAIN, RESPONSAVEL PELO RUN GLOBAL
main_sann_min <- function(vetorProcura,vetorSeraFds,lower,upper,numero_iteracoes){
#FUNCAO DE AVALIACAO
eval <- function(vetor){
#INIT VARIAVEIS PRINCIPAIS
custo_total <- 0;
